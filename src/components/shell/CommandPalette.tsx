...
export function CommandPalette({ open, onClose }: CommandPaletteProps) {
  ...
  const commands: CommandItem[] = useMemo(() => [
    ...
    { id: 'open-whiteboard', label: 'Open Whiteboard', icon: PenTool, group: 'Actions', action: () => navigate('/sketches/whiteboard') },
    { id: 'goto-diagrams', label: 'Go to Diagrams', icon: Waypoints, group: 'Navigation', action: () => navigate('/sketches') },
    { id: 'goto-tools', label: 'Go to Tools', icon: Wrench, group: 'Navigation', action: () => navigate('/tools') },
    { id: 'create-diagram', label: 'Create new diagram', icon: Waypoints, group: 'Actions', action: () => navigate('/sketches/new') },
