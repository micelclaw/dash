    ...
    children: [
      {
        ...
        children: [
          ...
          { path: '/finance/invoiceninja', lazy: () => import('@/modules/finance/InvoiceNinjaPage') },
          ...
          { path: '/crypto/toshi-moto', lazy: () => import('@/modules/crypto/ToshiMotoPage') },
          { path: '/crypto/btcpay', lazy: () => import('@/modules/crypto/BtcPayPage') },
