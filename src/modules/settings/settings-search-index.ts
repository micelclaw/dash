...
export const SETTINGS_SEARCH_INDEX: SettingsSearchEntry[] = [
  ...
  { sectionId: 'gpu-vram', groupId: 'ai-agents', label: 'GPU & VRAM',
    tags: ['gpu', 'vram', 'memoria', 'memory', 'models', 'modelos', 'ollama', 'vision', 'visión', 'coordinacion', 'arbitro', 'prioridad', 'priority', 'pausar', 'pause', 'liberar'],
    settings: ['modelos cargados', 'loaded models', 'vram libre', 'free vram', 'pausar gpu', 'liberar vram', 'free models', 'prioridad modelo', 'model priority', 'ventana inactividad', 'fijar modelo', 'pin model'] },
  ...
  { sectionId: 'drive', groupId: 'system', label: 'Drive',
    tags: ['drive', 'versioning', 'snapshots', 'versiones', 'team folders', 'carpetas del equipo', 'connected clients', 'clientes conectados', 'sesiones'],
    settings: ['versioning', 'snapshot retention', 'max versions per file', 'rotation policy', 'excluded patterns', 'team folders', 'host folders', 'read only', 'connected clients', 'sessions', 'devices'] },
