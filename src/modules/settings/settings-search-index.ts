...
export const SETTINGS_SEARCH_INDEX: SettingsSearchEntry[] = [
  ...
  { sectionId: 'sensor-fusion', groupId: 'system', label: 'Sensor Fusion',
    tags: ['sensor', 'fusion', 'context'],
    settings: ['home assistant', 'ha url', 'ha token', 'zone mapping', 'presence sensors'] },
