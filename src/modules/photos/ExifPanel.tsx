...
export function ExifPanel({ photo, onSaved, collapsed, onToggleCollapse }: ExifPanelProps) {
  ...
  const wasProcessed = photo.metadata?.ai_processed_at != null;
  const hasAiData = wasProcessed || photo.metadata?.ai_aesthetic_score != null || photo.metadata?.ai_description != null;
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: 16, display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        {(hasAiData || hasOverride) && (
          <FieldGroup title="AI">
            ...
            <ReadonlyField label="Faces" value={String(faceCount)} />
          </FieldGroup>
        )}
      </div>
